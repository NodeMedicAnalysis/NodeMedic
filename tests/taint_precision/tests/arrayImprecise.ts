...
test_suite("----------------- Imprecise Array tests (1) -------------------", function() {
    ...
    test_one("a[1] should be tainted", function() {
       __jalangi_assert_taint_true__(a[1]);
    });

});

test_suite("----------------- Imprecise Array tests (2) -------------------", function() {
...
test_suite("----------------- Imprecise Array tests (3) -------------------", function() {
...
test_suite("----------------- Imprecise Array tests (4) -------------------", function() {
